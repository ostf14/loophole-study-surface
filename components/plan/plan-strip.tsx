 ...
 *
 * Заливка stark-white, обводка soft-black — устройство компонента: в файле
 * это заливка-пометка в кольце soft-black, `strokeWeight` 2 при габарите 24.
 * Здесь габарит 8, и обводка взята из свойства инстанса — `stroke weight/2`,
 * то есть 1. Без кольца белое на песочной дорожке не видно вовсе (1.13:1);
 * кольцо даёт бусине край на обеих половинах, а белая середина остаётся тем
 * единственным белым, что на дорожке есть, и веху видно сразу.
 *
  ...
  return (
    ...
    >
      <span
        ...
        className="block size-2 rounded-full border-[1px] border-soft-black bg-stark-white"
      />
      <span
        className={cn(
